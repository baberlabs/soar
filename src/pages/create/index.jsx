...
export default function Create() {
  ...
  return (
    <Page
      heading="Create"
      description="Save a draft, an image, a recording, or a note that shows what
      ...
      <section className="space-y-5">
        <header className="flex flex-wrap items-end justify-between gap-3">
          <div>
            ...
            <h2 className="mt-1 font-ui text-3xl text-brand">Your creations</h2>
          </div>
          <Button
            type="button"
            fullWidth={false}
          ...
          >
            <Plus
              size={18}
              strokeWidth={2}
              className={`transition-transform ${isComposerOpen ? "rotate-45" : ""}`}
            />
            &nbsp;
