...
export default function NotFound() {
  ...
  return (
    <main className="mx-auto flex min-h-[70vh] w-full max-w-360 items-center px-6 py-24">
      <section className="mx-auto max-w-3xl rounded-4xl border border-brand/15 p-8 text-center shadow-[0_24px_48px_rgba(75,81,149,0.08)] backdrop-blur-sm md:p-10">
