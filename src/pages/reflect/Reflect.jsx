...
export function Reflect() {
  ...
  const saveLetterDraft = (event) => {
    ...
    const existingForMonth = letters.find(
      (entry) =>
        entry.targetMonth === letterTargetMonth &&
    ...
    const payload = {
      ...
      ...(activeLetterId || existingForMonth
        ? {}
        : { createdAt: new Date().toISOString() }),
    };
        ...
        {tab === "vision" ? (
              ...
              <div className="space-y-3 rounded-xl border border-brand/15 bg-beige/70 p-4">
                ...
                <div className="flex flex-wrap gap-2">
                  <Button
                    ...
                    onClick={
                      editingDraftItemId ? saveEditedDraftItem : addDraftItem
                    }
                  />
                  {editingDraftItemId ? (
                    <Button
            ...
            <section className="space-y-4">
              <article className="rounded-2xl border border-brand/20 bg-page p-5">
                  ...
                  {draftItems.length === 0 ? (
                    ...
                    draftItems.map((item, index) => {
                      ...
                      return (
                        <div
                          key={item.id}
                          className={`absolute rounded-xl border border-brand/15 bg-beige p-1 shadow-sm ${
                ...
                <p className="mt-3 font-body text-xs text-brand/65">
                  Drag cards to arrange freely. Use Edit/Delete directly on each
                  card.
                </p>
              </article>
          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_1fr]">
            ...
            >
              <h2 className="font-ui text-2xl text-brand">
                {activeLetterId
                  ? "Edit Next-Month Letter"
                  : "Write To Next-Month Self"}
              </h2>

              <div className="space-y-2">
                <label
                  htmlFor="letter-target-month"
                  className="font-body text-navy/60"
                >
                  Target month
                </label>
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  onChange={(event) =>
                    setLetterChallengePlan(event.target.value)
                  }
                    ...
                    {reviewLetterId === item.id ? (
                      <form onSubmit={saveReview} className="mt-4 space-y-3">
                        ...
                        <textarea
                          ...
                          onChange={(event) =>
                            setReviewWhatChanged(event.target.value)
                          }
